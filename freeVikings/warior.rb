...
module FreeVikings
  class Warior < Viking
    ...
    def init_images
      ...
      @image.add_pair('falling_', Image.new('baleog_standing.png'))
      @image.add_pair('falling_left', Image.new('baleog_left.png'))
      @image.add_pair('falling_right', Image.new('baleog_right.png'))
